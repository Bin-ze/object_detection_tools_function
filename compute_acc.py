...
class Cumpute_pred_acc:
    ...
    def __init__(self, pred_path, label_path, iou_thres=0.3, result_sava_path='./', classes_dict=None):
        """
    ...
    @staticmethod
    # 如果输入图片大小不一，请注意先读取img的尺寸在为该函数赋值
...
if __name__ == '__main__':
    ...
    # 该类支持使用预测txt进行画图操作，但需要注意原始图片大小
    # img_path = '/mnt/data/guozebin/coco/images/test/'
